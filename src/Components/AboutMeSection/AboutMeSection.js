		...
		<>
			<section id="about-me" className={styles.wrapper}>
				<div className={styles.paragraphWrapper}>
					...
					<p>
						<strong>
							I am front-end developer with almost 2 years of experience with React & Redux, and a lot
							more experienced graphic designer{' '}
						</strong>{' '}
						which might be helpful to bridge the gap between designers and developers in your team ✏️.
					</p>
					...
					<p>
						In my work I use the latest technologies 🚀 ensuring excellent performance.{' '}
						<strong>I care about the purity and transparency of the code, </strong>
						while maintaining appropriate semantics, standards, typing and naming. I love to use{' '}
				...
				<div className={styles.content}>
					...
					<div className={styles.description}>
						...
						<p>
							...
							<strong> displaying them correctly on every screen</strong>
						</p>
					</div>
				</div>
