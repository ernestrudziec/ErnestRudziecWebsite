...
const StyledX = styled.div`
	...
	transform: translate(-50%, -50%) ${({ active }) => (active ? 'scale(1)' : 'scale(0)')} !important;
`;
		...
		<>
			...
			<StyledNavigation active={isNavOpened}>
				<ul>
					...
					<AnchorLink onClick={() => setNavIsOpened(!isNavOpened)} href="#about-me">
						<StyledLi color="#52C0D6">
							<span>😅</span>about me
						</StyledLi>
					</AnchorLink>

					<AnchorLink onClick={() => setNavIsOpened(!isNavOpened)} href="#about-responsive">
						<StyledLi color="#ff2a6d">
							<span>👨‍💻</span>rwd
						</StyledLi>
					</AnchorLink>
					<AnchorLink onClick={() => setNavIsOpened(!isNavOpened)} href="#my-skills">
						<StyledLi color="#52C0D6">
							<span>⚡️</span>my skills
						</StyledLi>
					</AnchorLink>
					<AnchorLink onClick={() => setNavIsOpened(!isNavOpened)} href="#my-works">
						<StyledLi color="#ff2a6d">
							<span>🎨</span>my works
						</StyledLi>
					</AnchorLink>
					<AnchorLink onClick={() => setNavIsOpened(!isNavOpened)} href="#contact">
						<StyledLi color="#52C0D6">
